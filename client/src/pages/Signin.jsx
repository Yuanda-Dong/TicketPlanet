...
export default function SignInSide() {
	...
	const handleClickShowPassword = () => {
		setInfo({...info, showPassword: !info.showPassword});
	};
				...
				>
					...
					<Box component="form" noValidate onSubmit={handleSubmit} sx={{mt: 1}}>
								...
								endAdornment={
									<InputAdornment position="end">
										<IconButton
											...
											edge="end"
										>
											{info.showPassword ? <VisibilityOff/> : <Visibility/>}
										</IconButton>
									</InputAdornment>
								}
							/>
						...
						<Button
							...
							fullWidth
							variant="contained"
							sx={{mt: 3, mb: 2, backgroundColor: '#4f4cee'}}
					...
					<Button color={"error"} startIcon={<GoogleIcon/>} sx={{margin: '0 0'}} variant="contained"
